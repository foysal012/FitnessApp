...
//                   child: UnitRuler(
//                     height: 400, // Height of the ruler
...
class LoginIntroductionScreen2 extends StatefulWidget {
  const LoginIntroductionScreen2({super.key});

  @override
  State<LoginIntroductionScreen2> createState() => _LoginIntroductionScreen2State();
}

class _LoginIntroductionScreen2State extends State<LoginIntroductionScreen2> with SingleTickerProviderStateMixin{
